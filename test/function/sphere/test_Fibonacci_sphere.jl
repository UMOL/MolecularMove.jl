...
function test_Fibonacci_sphere(test_vector::Array, count::Integer, radius::AbstractFloat, solution::Array)
    ...
    answer = vcat([transform(test_vector) for transform in sphere(Fibonacci, count, radius)]...)
...
@time test_Fibonacci_sphere([0. 0. 0.], 5, 10.,
    [ 6.                 0.               8.;
...
@time test_Fibonacci_sphere([0. 0. 0.; 0. 0. 0.], 5, 10.,
    [ 6.                 0.               8.;  
      6.                 0.               8.;
     -6.758097397797128  6.190970809322855  4.; 
     -6.758097397797128  6.190970809322855  4.;
